...
name: skill-creator
description: >
  Guide for creating effective Claude skills with specialized knowledge and workflows.
  Use when: (1) creating a new skill, (2) updating an existing skill,
  (3) learning skill best practices, (4) designing skill architecture.
  Triggers: "create skill", "new skill", "build skill", "skill template",
  "skill guide", "make a skill", "custom skill".
---
