...
description: >
  Create algorithmic and generative art using p5.js with seeded randomness.
  Use when: (1) creating generative art, (2) making flow fields or particle systems,
  (3) building interactive visual experiments, (4) creating code-based art.
  Triggers: "generative art", "algorithmic art", "p5.js", "flow field",
  "particle system", "creative coding", "procedural art", "code art".
---
