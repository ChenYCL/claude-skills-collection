...
name: theme-factory
description: >
  Apply visual themes to artifacts including slides, docs, reports, and HTML pages.
  Use when: (1) styling a document or presentation, (2) applying consistent branding,
  (3) choosing colors and fonts for a design, (4) theming HTML/CSS content.
  Triggers: "apply theme", "style this", "change colors", "theme", "branding",
  "color scheme", "font style", "visual style", "make it look better".
---
