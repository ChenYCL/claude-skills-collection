...
description: >
  ...
  Use when: (1) creating GIFs for Slack reactions, (2) making animated emojis,
  (3) optimizing GIFs for messaging platforms, (4) creating small animations.
  Triggers: "gif for slack", "slack gif", "animated emoji", "create gif",
  "make a gif", "slack animation", "reaction gif".
---
