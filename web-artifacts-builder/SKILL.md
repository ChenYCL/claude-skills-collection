...
description: >
  Create elaborate HTML artifacts using React, Tailwind CSS, and shadcn/ui components.
  Use when: (1) building complex web components, (2) creating interactive artifacts,
  (3) using shadcn/ui components, (4) multi-component React applications.
  Triggers: "web artifact", "react component", "shadcn", "tailwind",
  "interactive widget", "dashboard component", "complex UI", "web app".
---
