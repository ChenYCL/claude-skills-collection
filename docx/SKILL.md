...
name: docx
description: >
  Word document handler for creating, reading, editing, and manipulating .docx files.
  Use when: (1) creating Word documents with formatting, (2) reading/extracting from .docx,
  (3) working with tables of contents, headings, page numbers, (4) tracked changes/comments.
  Triggers: "Word doc", "word document", ".docx", "report", "memo", "letter",
  "template", "manuscript", "essay", "documentation", "tracked changes".
---
